    ...
    return (
        <div className="profile-container">
            <header>
                ...
                <Link className="button" to="/incident/new">Registar novo caso</Link>
            ...
            <ul>
                {
                    incidents.map( incident => (
                        <li key={incident.id}>
                            ...
                            <strong>VALOR:</strong>
                            <p>{Intl.NumberFormat('pt-PT',  { style: 'currency',currency: 'AKZ' }).format(incident.value)}</p>
